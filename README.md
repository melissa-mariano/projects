...
Classement des bigrammes et trigrammes RSE les plus fréquents.

Liste des unigrammes RSE par entreprise (CSV).

Principaux termes RSE par secteur d’activité (CSV).

📍 Notebook principal : notebooks/rse_cac40.ipynb (exécutable sur Google Colab).
